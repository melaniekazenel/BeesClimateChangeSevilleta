...
# Historic Climate Data and Predicted Future Climate Data from GCMs other than CanESM2
...
### NOTE: Run this code separately for each GCM, reading in that GCM's data below ###
...
##### Initial Calculations: Projected Future Climate Data #####
...
combined_data_subset <- bind_rows(fp4.5_spei_subset_wide,fp8.5_spei_subset_wide,b4.5_spei_subset_wide,b8.5_spei_subset_wide)
